...
//
// 링크는 **읽으라고 있는 게 아니라 복사하라고 있다.** 그래서 ShareLinkRow 를
// 쓴다 — 앞부분만 보이고, 누르면 바로 복사된다.
//
// 예전엔 /invitations 쪽에 같은 이름의 사본이 하나 더 있었다(125줄). 그 화면을
// 없애면서 사본도 지웠다 — 이제 초대장 공유는 이 파일 하나가 맡는다.
